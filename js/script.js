...
// Fill 95% of viewport height, constrain width
let dh = ch * 0.95;
let dw = dh * ir;
if(dw > cw * 0.9){ dw = cw * 0.9; dh = dw / ir; }
...
/* =========================
MOBILE SCROLL — smooth character animation only
Character stays centered behind content at consistent opacity.
Content is always visible, scrolls naturally on top.
========================= */
...
// Map scroll to character frames — smooth animation as user scrolls
...
/* =========================
MOBILE INTRO — typing animation
========================= */

function mobTypeName(){
const name = “Smit Patel”;
const el = document.getElementById(“mobIntroName”);
const layout = document.getElementById(“mobileLayout”);
if(!el) return;

// Hide content during intro
if(layout) layout.classList.add(“intro-active”);
...
if(i === name.length){
clearInterval(t);
// Brief pause to let the full name sit, then fade out
el.classList.add(“done”);
setTimeout(mobIntroFinish, 1200);
}
}, 120);
}

function mobIntroFinish(){
const intro = document.getElementById(“mobIntro”);
const layout = document.getElementById(“mobileLayout”);

// Fade out intro overlay
if(intro) intro.classList.add(“fade-out”);

// After fade, reveal content and nav
setTimeout(()=>{
if(intro) intro.style.display = “none”;
if(layout) layout.classList.remove(“intro-active”);
document.body.classList.add(“nav-visible”);
}, 800);
}
...
animateMob();
updateMobScroll();
// Start typing animation instead of showing content immediately
mobTypeName();
} else {
renderFrame(0);
typeName();
